                ...
                <div className="row">
                    <div className="col">
                        <form onSubmit={handleSubmit(simpan)}>
                            ...
                            <div className="mb-4">
                                <input type="submit" className="btn btn-primary me-2" name="submit" value="Pay Now" />
                                <input type="submit" className="btn btn-secondary " name="submit" value="Cancel" onClick={ ()=>setMopen(false) } />
                            </div>
                        </form>
                    </div>
                </div>
